...
const ProjectHero = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center px-4 sm:w-full mob:w-full lg:w-2/5 flex flex-col items-center justify-center">
        <h1
          className="
