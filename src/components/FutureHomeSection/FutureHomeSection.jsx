      ...
      <div className="lg:space-y-20 w-full mx-auto">
        ...
        <div className="lg:space-y-10 sm:space-y-10 mob:space-y-5 mob:mb-20">
          <div className="flex flex-col sm:px-0 lg:flex-row lg:items-center lg:justify-between lg:gap-8 sm:gap-2 lg:px-0 sm:px-10 mob:px-0 mob:pt-10">
            <h2
              className="
                lg:text-1.8rem font-heading font-regular text-black
            ...
            <p
              className="text-[0.875rem] leading-[1.25rem] tracking-[0.02em] text-gray-800 font-[Onest] font-normal capitalize lg:w-[60%] sm:font-onest sm:font-normal sm:text-[14px] sm:leading-[20px] sm:tracking-[0.02em] sm:capitalize
