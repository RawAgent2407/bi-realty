  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 sm:bottom-14 lg:left-32 sm:left-10 z-20 mob:left-5">
        ...
        <p className="lg:text-left capitalize font-[Onest] font-normal text-[1rem] leading-[1.25rem] tracking-[0.02em] text-white-800 max-w-2xl mb-6 sm:text-left mob:text-[0.9rem] mob:text-left">
          {description}
        </p>
      </div>
    </section>
